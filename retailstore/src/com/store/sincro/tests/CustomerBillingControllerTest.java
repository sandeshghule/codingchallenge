...
/*
 * The Test class for customer billing controller
 * 
 */
public class CustomerBillingControllerTest {
	...
	public void test13() throws Exception {
		double cartTotal = customerBillingController.calculateCartTotal(PREMIUM, 0);
		assertEquals(0, cartTotal,0);
	}
	
	@Test(expected=Exception.class)
	public void test14() throws Exception {
		customerBillingController.calculateCartTotal(PREMIUM, -12);
	}
}
